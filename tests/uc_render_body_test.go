...
func (c *RenderableComp) String() string { return "" }

// StaticTestComp implements only String for testing the fallback path.
type StaticTestComp struct {
	*dom.Element
}

func (c *StaticTestComp) String() string {
...
func TestBodyHeadResolution(t *testing.T) {
	...
	t.Run("Append ViewRenderer to body", func(t *testing.T) {
		comp := &RenderableComp{Element: Div(), label: "body-append"}
	...
	t.Run("Append String to body", func(t *testing.T) {
		comp := &StaticTestComp{Element: Div()}
	...
	t.Run("Append to head", func(t *testing.T) {
		...
		// Override String to be valid head content
...
func TestAutoID(t *testing.T) {
	...
	comp := &RenderableComp{Element: Div(), label: "auto"}
